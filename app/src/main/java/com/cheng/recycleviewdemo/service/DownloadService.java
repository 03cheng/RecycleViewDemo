package com.cheng.recycleviewdemo.service;
...
import com.cheng.recycleviewdemo.util.DownloadListener;
import com.cheng.recycleviewdemo.util.DownloadTask;
        ...
        public void cancelDownload() {
            if (downloadTask != null) {
                ...
                if (downloadUrl != null) {
                    ...
                    File file = new File(directory + "/Meizis" + fileName);
                    if (file.exists()) {
                        file.delete();
                    }
